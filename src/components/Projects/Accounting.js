  ...
  return (
    <div>
      ...
      <div className="product-title-container">
        <h1 className="product-title  white w500 top-3xl bottom-2xl ">
          Simple online accounting for every business.
        </h1>
      </div>
      ...
      <section>
        <div className="project-content-section">
          ...
          <div className="pieces-div">
            ...
            <BlockText
              title={accountingContent.intro_title}
              content={accountingContent.intro_paragraph}
            />
