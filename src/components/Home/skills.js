        ...
        <section className="skills-section section-gap">
            ...
            <div className="stickyContainer mgb10">
                ...
                <div className="stickynote yellowSticky rotateleft">
                    ...
                    <p className="md">Wireframing, Rapid Prototyping,
                        Responsive design, Design Systems,
                        Visual Design, Interaction Design,
                        Illustration, Animation, Agile & lean UX</p>
                </div>

                <div className="stickynote redSticky">
                    <p className="lg">Research</p>
                    <p className="md">User Research, Usability Testing,
                        Customer Journey Mapping, Personas,
                        Storyboarding, Affinity Diagrams,
                        Workshopping, Information Architecture</p>
                </div>

                <div className="stickynote blueSticky rotateright">
                    <p className="lg">Toolkit</p>
                    <p className="md">Figma, Adobe XD, Sketch, Webflow,
                        Adobe CC (Illustrator, Photoshop,
                        Indesign), Procreate, Basic HTML &
                        CSS, Unreal Engine (VR), Pen+paper</p>
                </div>
